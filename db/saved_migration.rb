def self.up
  ...
  create_table "globalize_regions" do |t|
    t.string "code",         :limit => 2
  ...
  create_table "personal_statuses" do |t|
    t.string "name"
    t.string "name_de"
    t.string "name_es"
  end

  create_table "piggy_bank_account_transactions" do |t|
  ...
  create_table "piggy_bank_accounts" do |t|
    t.integer  "cents",                :default => 0,     :null => false
  ...
  create_table "products_product_prices" do |t|
...
def self.down
  ...
  drop_table "admin_roles_admin_users", :id => false
  ...
  drop_table "payments"
  drop_table "people"
  drop_table "people_spoken_languages", :id => false
  drop_table "personal_statuses"
  drop_table "piggy_bank_account_transactions"
  drop_table "piggy_bank_accounts"
  drop_table "polls"
  drop_table "product_lines"
  drop_table "product_prices"
  drop_table "products_product_prices"
  drop_table "ratings"
  ...
  drop_table "rewards"
  drop_table "rights"
  drop_table "rights_roles", :id => false
  drop_table "roles"
  drop_table "roles_users", :id => false
  drop_table "schema_info", :id => false
  drop_table "sessions"
